...
def add_drop_region():  # adds a drop region for the faulty gripper challenge
    ...
    update_min_x_label = partial(add_drop_wind, x_min_val_current, get_current_x_min)
    ...
    update_min_y_label = partial(add_drop_wind, y_min_val_current, get_current_y_min)
    ...
    update_min_z_label = partial(add_drop_wind, z_min_val_current, get_current_z_min)
    ...
    update_max_x_label = partial(add_drop_wind, x_max_val_current, get_current_x_max)
    ...
    update_max_y_label = partial(add_drop_wind, y_max_val_current, get_current_y_max)
    ...
    z_val_max_slide = ttk.Scale(add_drop_wind, from_=0, to=5, orient="horizontal", variable=z_val_max)
    z_val_max_slide.pack()
    get_current_z_max = - partial(get_current_val, z_val_max)
    z_max_val_current = tk.Label(add_drop_wind, text="Current value = "+get_current_z_max())
    z_max_val_current.pack()
    update_max_z_label = partial(add_drop_wind, z_max_val_current, get_current_z_max)
    z_val_max.trace('w', update_max_z_label)
    x_val_dest_label = tk.Label(add_drop_wind, text="Enter the destination x value")
    x_val_dest_label.pack()
    x_val_dest_slide = ttk.Scale(add_drop_wind, from_=0, to=5, orient="horizontal", variable=x_val_dest)
    x_val_dest_slide.pack()
    get_current_x_dest = - partial(get_current_val, x_val_dest)
    x_dest_val_current = tk.Label(add_drop_wind, text="Current value = "+get_current_x_dest())
    x_dest_val_current.pack()
    update_dest_x_label = partial(add_drop_wind, x_dest_val_current, get_current_x_dest)
    x_val_dest.trace('w', update_dest_x_label)
    y_val_dest_label = tk.Label(add_drop_wind, text="Enter the destination y value")
    y_val_dest_label.pack()
    y_val_dest_slide = ttk.Scale(add_drop_wind, from_=0, to=5, orient="horizontal", variable=y_val_dest)
    y_val_dest_slide.pack()
    get_current_y_dest = - partial(get_current_val, y_val_dest)
    y_dest_val_current = tk.Label(add_drop_wind, text="Current value = "+get_current_y_dest())
    y_dest_val_current.pack()
    update_dest_y_label = partial(add_drop_wind, y_dest_val_current, get_current_y_dest)
    y_val_dest.trace('w', update_dest_y_label)
    z_val_dest_label = tk.Label(add_drop_wind, text="Enter the destination z value")
    z_val_dest_label.pack()
    z_val_dest_slide = ttk.Scale(add_drop_wind, from_=0, to=5, orient="horizontal", variable=z_val_dest)
    z_val_dest_slide.pack()
    get_current_z_dest = - partial(get_current_val, z_val_dest)
    z_dest_val_current = tk.Label(add_drop_wind, text="Current value = "+get_current_z_dest())
    z_dest_val_current.pack()
    update_dest_z_label = partial(add_drop_wind, z_dest_val_current, get_current_z_dest)
    z_val_dest.trace('w', update_dest_z_label)
    ...
    dropsInfo.append(Drops(temp_frame.get(), str("["+get_final_num(x_val_min)+", "+get_final_num(y_val_min)+", "+get_final_num(z_val_min)+"]"),
                           str("["+get_final_num(x_val_max)+", "+get_final_num(y_val_max)+", "+get_final_num(z_val_max)+"]"),
                           str("["+get_final_num(x_val_dest)+", "+get_final_num(y_val_dest)+", "+get_final_num(z_val_dest)+"]"),
