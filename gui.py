...
def get_k_products():  # adds a product to kitting
    ...
    x_val_k_label.pack()
    x_val_k_slide = ttk.Entry(k_products, textvariable=x_val_k)
    x_val_k_slide.pack()
    y_val_k_label = tk.Label(k_products, text="Enter the y value")
    y_val_k_label.pack()
    y_val_k_slide = ttk.Scale(k_products, textvariable=y_val_k)
    y_val_k_slide.pack()
    z_val_k_label = tk.Label(k_products, text="Enter the z value")
    z_val_k_label.pack()
    z_val_k_slide = ttk.Scale(k_products, textvariable=z_val_k)
    z_val_k_slide.pack()
