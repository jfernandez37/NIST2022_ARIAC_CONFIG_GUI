...
if __name__ == "__main__":
    ...
    trayInstructions.grid(column=leftColumn, sticky=tk.W)
    table1 = tk.StringVar()
    table1.set("")
    table1Label = tk.Label(trayInfo, text="Choose the material for table 1")
    table1Label.grid(column=leftColumn, sticky=tk.W)
