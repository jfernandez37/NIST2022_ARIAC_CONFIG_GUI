...
def add_drop_region():  # adds a drop region for the faulty gripper challenge
    ...
    update_max_z_label = partial(update_val_label, z_max_val_current, get_current_z_max)
    ...
    update_dest_x_label = partial(update_val_label, x_dest_val_current, get_current_x_dest)
    ...
    update_dest_y_label = partial(update_val_label, y_dest_val_current, get_current_y_dest)
    ...
    update_dest_z_label = partial(update_val_label, z_dest_val_current, get_current_z_dest)
