...
def add_product():  # adds a product in agv_infos
    ...
    z_val_entry.pack()
    r_x_val_label = tk.Label(product_info, text="Enter the r value")
    r_x_val_label.pack()
    r_x_val_entry = tk.Entry(product_info, textvariable=r_x_val)
    r_x_val_entry.pack()
    r_y_val_label = tk.Label(product_info, text="Enter the p value")
    r_y_val_label.pack()
    r_y_val_entry = tk.Entry(product_info, textvariable=r_y_val)
    r_y_val_entry.pack()
    r_z_val_label = tk.Label(product_info, text="Enter the y (rpy) value")
    r_z_val_label.pack()
...
def add_drop_region():  # adds a drop region for the faulty gripper challenge
    ...
    r_x_val_dest_label = tk.Label(add_drop_wind, text="Enter the r value for the destination")
    r_x_val_dest_label.pack()
    r_x_val_dest_entry = tk.Entry(add_drop_wind, textvariable=r_x_val_dest)
    r_x_val_dest_entry.pack()
    r_y_val_dest_label = tk.Label(add_drop_wind, text="Enter the p value for the destination")
    r_y_val_dest_label.pack()
    r_y_val_dest_entry = tk.Entry(add_drop_wind, textvariable=r_y_val_dest)
    r_y_val_dest_entry.pack()
    r_z_val_dest_label = tk.Label(add_drop_wind, text="Enter the y (rpy) value for the destination")
